...
- **四维加权评分**：设计合理性与技术诚实性 25 / 可追踪性与心智负担 25 / 人类可读性与自我解释性 20 / AI 屎山与许愿痕迹 30
...
- **结构性硬闸门**：存在使人类无法/极难维护的结构性事实（超长 god-function、体量超人类可维护、为 AI 编码过程的注释成规模、AI 排查残留混入热路径）时总分硬性封顶——不被测试/CI/文档纪律等工程表面迷惑
...
| 可追踪性与心智负担 | 25 | 人类能追踪请求→代码吗？改动一处需知几处？逻辑边界清晰还是混成一团？ |
| 人类可读性与自我解释性 | 20 | 代码能自我解释吗？命名/注释是帮人懂「为什么」还是写给 AI/清单看？ |
| AI 屎山与许愿痕迹（反向计分） | 30 | 承诺-实现背离、过度工程、无效抽象、为 AI 写的注释、god-file、幻觉注释——痕迹越多分越低 |
